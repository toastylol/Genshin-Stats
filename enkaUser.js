        ...
        const payload = {
            ...
            data: {
                dynamic: [
                    ...
                    { type: 1, name: "aby", value: `${player.towerFloorIndex} - ${player.towerLevelIndex} (${player.towerStarIndex}★) || not-cleared` },
                    { type: 1, name: "img_str", value: "Imaginarium Theatre" },
                    { type: 1, name: "img", value: `Act ${player.theaterActIndex}${player.theaterModeIndex === 109 ? '-2' : ''} (${player.theaterStarIndex}★) || not-cleared` },
                    { type: 1, name: "sty_str", value: "Stygian Onslaught" },
                    { type: 1, name: "sty", value: `Diff ${player.stygianIndex} - ${player.stygianSeconds}s || not-cleared` },
